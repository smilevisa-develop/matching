  ...
  try {
    ...
    if (action === "fill") {
      ...
      const demoTranscripts: Record<string, string> = {
        ...
        work_experience:
          "ミャンマーで、食品工場で三年、働きました。お弁当を作る仕事でした。材料を切ったり、機械を使ったりしました。だから、日本でも食品の仕事をしたいです。",
        reason_japan: "日本の技術を勉強したいからです。それに、家族のために働きたいので、日本に来ました。",
        study_method: "毎日、アプリで単語を勉強しています。それから、週に二回、学校で先生と話す練習をしています。",
      };
