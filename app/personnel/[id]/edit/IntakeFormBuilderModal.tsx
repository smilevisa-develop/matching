        ...
        <div className="flex-1 space-y-5 overflow-y-auto px-6 py-5">
          {loading ? (
            ...
            <>
              ...
              {/* 日本語チェックはこのフォームには含まれない (専用リンクで別送) */}
              <p className="rounded-2xl border border-gray-200 bg-gray-50 px-4 py-3 text-xs leading-relaxed text-gray-500">
                🎙️ 日本語チェック（録音）は、このフォームとは
                <span className="font-semibold text-[var(--color-text-dark)]">別のリンク</span>
                で送ります。上部のマイクのボタンから発行してください。
              </p>
